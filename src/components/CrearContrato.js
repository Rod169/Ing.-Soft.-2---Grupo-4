...
// Importamos el servicio de contratos para manejar la lógica relacionada con los contratos
import ContratoService from '../funcionalidades/ServicioContrato/ContratoService';

const CrearContrato = () => {
  // Definimos el estado para la categoría, producto e imagen del contrato
  ...
  const manejarEnvioFormulario = (e) => {
    ...
    // Crea un objeto contrato con los datos del formulario
    const contrato = {
    ...
    // Llama al servicio para crear el contrato
    ContratoService.crearContrato(contrato);
    alert('Contrato creado exitosamente'); // Mensaje de éxito

    // Limpia el formulario después de crear el contrato
  ...
  return (
    <div className="formulario-contrato-container"> {/* Contenedor del formulario */}
      <h2>Crear Contrato</h2> {/* Título del formulario */}
      <form onSubmit={manejarEnvioFormulario}> {/* Formulario que maneja el envío */}
        ...
        {/* Campo para seleccionar el tipo de contrato */}
